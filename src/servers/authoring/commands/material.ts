...
import { bakeMeshMaps, serializeBakedMaps, getMapsStats, BakedMeshMaps } from '../../../demos/MeshMapBaker';
import { NAMED_COLORS, listColorsByCategory } from '../../../platform/materials/MaterialLibrary';
